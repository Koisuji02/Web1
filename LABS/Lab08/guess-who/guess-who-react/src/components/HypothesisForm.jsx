...
function HypothesisForm() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      // Invio dell'ipotesi al server
      await API.addHypothesis(1, { // Supponendo che il gameId sia 1
        property: formState.property,
        value: formState.value,
        correct: false, // Puoi modificare questo valore in base alla logica
      });
      ...
      setFormState((prevState) => ({
        ...prevState,
        error: "Error submitting hypothesis. Please try again.",
      }));
    }
  };
