...
function Answers () {
  // anche qui gli stati sono inizializzati vuoti in quanto li prendo dall'API.mjs
  const [answers, setAnswers] = useState([]);

  // il questionId viene passato come parametro all'interno dell'URL e preso con useParams
  const { questionId } = useParams();

  // con useEffect chiamo le informazioni dal server (API), ma qui serve anche il questionId
  useEffect(() => {
